...
<html>
    ...
    <body style="background-image: linear-gradient( 135deg, #FFA8A8 10%, #FCFF00 100%);">
        <?php
            ...
            echo " <a href= \"banners_nuevo.php? 
            \" <span id=\"nuevo_registro\">Nuevo banner</span>  </a><br>";
            ...
            while ($row = $res->fetch_array()){
                ...
                <div class= \"columna\">|<a href= \"banners_detalle.php?id=+$id\" data-id=\"$id\" >Ver detalles</a><br></div>
                <div class= \"columna\">|<a href= \"banners_edita.php?id=+$id\" data-id=\"$id\" >Editar</a><br></div>
